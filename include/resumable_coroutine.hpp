#ifndef RESUMABLE_COROUTINE_INCLUDE_RESUMABLE_COROUTINE_HPP
#define RESUMABLE_COROUTINE_INCLUDE_RESUMABLE_COROUTINE_HPP
#include <exception>
#include <coroutine>
...
#endif //RESUMABLE_COROUTINE_INCLUDE_RESUMABLE_COROUTINE_HPP
